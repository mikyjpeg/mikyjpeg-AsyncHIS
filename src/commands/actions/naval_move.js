...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('naval_move')
        .setDescription('Cost is to move ALL friendly naval units to an adjacent port or sea zone. If enter a sea zone or port with enemy naval units, naval combat is initiated.')
